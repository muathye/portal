...
<span class="line"></span></code></pre></div><div class="tip custom-block"><p class="custom-block-title">A note about the backslash</p><ul><li>In the article, we are using a backslash \\ to make the text fit on the screen without inserting newline &#39;\\n&#39; characters.</li><li>GPT-3 isn&#39;t really affected whether you insert newline characters or not. But when working with LLMs in general, you may consider whether newline characters in your prompt may affect the model&#39;s performance.</li></ul></div>`,73),t=[p];function c(r,i,y,u,D,C){return a(),n("div",null,t)}const A=s(o,[["render",c]]);export{d as __pageData,A as default};
